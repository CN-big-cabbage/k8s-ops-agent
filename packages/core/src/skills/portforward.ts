...
export const K8sPortForwardSchema = z.object({
...
export async function handleK8sPortForward(params: K8sPortForwardParams, pluginConfig?: PluginConfig): Promise<string> {
  try {
