...
import { getEventTimestamp } from "./events.js";

// --- Schema ---

export const K8sEventAnalysisSchema = z.object({
...
export async function handleK8sEventAnalysis(params: K8sEventAnalysisParams, pluginConfig?: PluginConfig): Promise<string> {
  try {
