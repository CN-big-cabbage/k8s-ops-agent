...
export type K8sExecParams = z.infer<typeof K8sExecSchema>;
...
export async function handleK8sExec(params: K8sExecParams, pluginConfig?: PluginConfig): Promise<string> {
  try {
