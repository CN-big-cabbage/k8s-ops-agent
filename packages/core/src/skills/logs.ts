...
export type K8sLogsParams = z.infer<typeof K8sLogsSchema>;
...
export async function handleK8sLogs(params: K8sLogsParams, pluginConfig?: PluginConfig): Promise<string> {
  try {
